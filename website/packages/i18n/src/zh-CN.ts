export const zhCN = {
  ...
  home: {
    ...
    lead: "数学是语言。人工智能是主要实验室。其他学科只在结构真正共享时进入。",
    spine: "表示 → 学习 → 生成 → 智能",
    threadsTitle: "两条主线",
    mathTitle: "数学",
    mathBody: "结构按章节需要引入：向量空间、概率、优化、信息、动力学。没有单独的先修部。",
    aiTitle: "人工智能",
    aiBody: "模型与算法是实验。书写的是正在使用的数学对象，而不是当下的产品名。",
    topicsTitle: "后续话题",
    topicsBody: "金融、物理、控制、信息论可以在桥接成立后作为可选话题出现，它们不占据仓库顶层。",
    ctaRead: "阅读全书",
